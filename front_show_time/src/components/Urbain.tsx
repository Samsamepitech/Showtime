...
useEffect(() => {
  ...
  getConcerts()
    ...
    return (
      <>
      <div className="mainTitle"><h5 className='PreviousType'><Button type="button" className="btn btn-outline-secondary"><Link to={{pathname: `/`}}><h4>Back to Home</h4></Link></Button></h5>
      <img className="d-block w-60" width="100%" height="30%" src="../images/urba.png"/></div>
