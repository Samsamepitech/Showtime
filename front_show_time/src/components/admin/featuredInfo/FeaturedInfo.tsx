...
export default function FeaturedInfo() {
  ...
  return (
    <div className="featured">
        ...
        <div className="featuredSub">Compared to last month : +{bookings.length} <span className="arrow"></span> </div>
        </div>
        <div className="featuredItem">
            <span className="featuredTitle">
                Number of users
        ...
        <div className="featuredSub">Compared to last month: +{users.length} </div>
        </div>
        <div className="featuredItem">
            <span className="featuredTitle">
        ...
        <div className="featuredSub">Compared to last month: +95% </div>
        </div>
    </div>
  )
}